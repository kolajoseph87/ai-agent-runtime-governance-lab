...
def secure_coding_control_evidence() -> tuple[ControlEvidence, ...]:
    ...
    return (
        ...
        ControlEvidence("C-T4-LATENCY", "policy_latency_budget", ControlLayer.RUNTIME, True, True,
            "governance/operations.py", "test_operations.py::test_latency_budget_fails_closed_at_critical_boundary", pre_tool),
        ControlEvidence("C-T4-READY", "component_readiness", ControlLayer.INFRASTRUCTURE, True, True,
            "governance/operations.py", "test_operations.py::test_health_probe_returns_unhealthy_instead_of_throwing"),
