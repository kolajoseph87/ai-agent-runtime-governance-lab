...
- Chapter 2: completed — principal/agent/tool identity, immutable execution context, trust boundaries, fail-closed permit/deny pipeline
- Chapter 3: completed — immutable versioned rule sets, priority validation, local diagnostics, and layered input/tool/output enforcement
- Chapter 4: safe mock repository and test tools with execution rings and pre-execution policy checks
...
- Chapter 7: advanced output filtering for client data and unsafe generated code
